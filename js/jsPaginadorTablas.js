/*
			...
			*/
			...
			(function ( $ ) {
				...
				{
					var pagination = "<span><button class='btn btn-info paginationInit'><i class=\"material-icons\">keyboard_arrow_left</i></button></span> ";
					for (var i = 1; i <= last; i++)
					{
						pagination += "<span><button class='btn btn-info paginationClick'>" + i + "</button></span> ";
					}
					pagination += "<span><button class='btn btn-info paginationEnd'><i class=\"material-icons\">keyboard_arrow_right</i></button></span>"
