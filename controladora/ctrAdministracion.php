		...
		function actualizarAdministracion(){
            ...
            $logicaAdmi = new logicaAdministracion();
	      	if($logicaAdmi->actualizarAdministracion($administracion) == true){
	      		echo 
	      		'	
	      			Se ha modificado correctamente la administración del riesgo.
	      		';
	      	} else {
	      		echo 
	      		'	
	      			Error! No se ha podido modificar la administración del riesgo.
	      		';
	      	}
		}
		function eliminarAdministracion(){
			...
			$idAdmi = $_POST['idAdmi'];
	      	...
	      	if($logica->eliminarAdmi($idAdmi) == true){
	      		echo 
	      		'	
	      			Se ha eliminado correctamente la administración del riesgo.
	      		';
	      	} else {
	      		echo 
	      		'	
	      			Error! No se ha podido eliminar la administración del riesgo.
	      		';
	      	}
		}
	}
