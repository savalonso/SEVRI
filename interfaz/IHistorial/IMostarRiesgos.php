							...
							if($lista==null){
								...
								foreach ($lista as $riesgo){
						            echo "<tr id=\"tr".$contador."\" style=\"display:none\">
						        		...
						        		<td><input class=\"btn btn-default btnAccionCrud\" type=\"button\" value=\"Ver detalles\" onclick=\"		cargarPagina('../interfaz/IHistorial/IVerDetalles.php?idRiesgo=".$riesgo->getId()."&idSevri=".$riesgo->getIdSevri()."')\"/></td>
						    		</tr>";
						    		$contador++;
								}
							}
